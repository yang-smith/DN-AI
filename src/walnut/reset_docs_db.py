...
import walnut.memory.loader
import walnut.memory.graph_extractor
import walnut.memory.db
import os
...
db = walnut.memory.db.DB(sqlitedb_path=f"{dir_path}/sqlite.db", vecdb_path=f"{dir_path}/chroma")
