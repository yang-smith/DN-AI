...
import tiktoken
from walnut.utils.prompt import prompt_sys, prompt_tools
...
async def ai_chat_AsyncOpenAI(message, model="gpt-3.5-turbo", response_format='NOT_GIVEN'):
    if model == 'deepseek-chat':
        client = AsyncOpenAI(
            api_key=os.environ.get("DEEPSEEK_API_KEY"),
            base_url=os.environ.get("DEEPSEEK_API_BASE"),
...
# import os
# from openai import OpenAI
# from walnut.utils.db import get_document_by_similar_search, get_records_by_similar_search, get_records_by_time, collection,collection_DN
