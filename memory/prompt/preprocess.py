...
-Goal-
将群聊记录转化为易于记忆和检索的文本段落，保持对话的完整性和连贯性。
...
-Workflow-
1. 理解聊天记录：识别关键主题和参与者。
2. 聚类分割：根据主题相关性和时间顺序进行逻辑分割。
3. 文本转化：将分割后的记录转为丰富的文本，保留尽可能多的信息。
4. 格式化输出：按指定格式输出结果。

-Priority Information-
1. 活动组织
2. 所有活动参与者（记录每一个参加者，不要使用‘等’）
3. 重要决策或共识
4. 关键参与者的核心观点
5. 具体的时间和地点信息
...
-Example-
Input:
张三 (2023-05-01 10:00): 大家周末有空吗？想组织一次烧烤。
李四 (2023-05-01 10:05): 我有空，地点定了吗？
王五 (2023-05-01 10:10): 周六可以，周日不行。
张三 (2023-05-01 10:15): 那就定在周六吧，地点我再看看，到时发位置。
...
Output:
2023年5月1日上午10点，张三发起周末烧烤活动提议。李四表示有空并询问地点，王五表示周六可行。最终确定在周六举行，具体地点待定。
2024年7月16日晚上，小K组织了激情环法季第3趴活动。活动将观看环法自行车赛第16赛段的最后30公里，这是本届赛事最后一个平路冲刺赛段。活动定于当晚10:30在B1讨论室举行，预计观赛时长1小时。K.C.赞助西瓜，现场还准备了瓜子和花生。参与者包括小K、K.C.、阿德、阿银、Yaya安之、Way、卓力力、味味在这里共11人。
